...
MountJournalEnhancedFamily = {
    ...
    ["Cats"] = {
        -- also: Undead Cats, Flamesabers, Flying Stone Cats
        ['keywords'] = {
            "tiger",
            "panther",
            "lion",
    ...
    ["Chimeras"] = {
        ['keywords'] = {"rylak", "chimera", "quilen", "huntermount"},
    },
    ...
    ["Mechanostriders"] = {
        ['keywords'] = {"mechastrider", "mechanostrider", "battlestrider"},
    },
    ...
    ["Turtles"] = {
        ['keywords'] = {"turtle", "pandaranmount"},
    },

    ["Water Striders"] = {
        ['keywords'] = {"waterstrider"},
    },

    ["Wolves"] = {
        ['keywords'] = {"direwolf", "wolfdraenor"},
        [23509] = "Frostwolf Howler",
        [92232] = "Spectral Wolf",
